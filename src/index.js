...
const svg = d3.select("#map").append("svg").attr("width", width).attr("height",height - 150);
...
function extractData() {
    d3.csv(csvFile).then(function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            winner.push({id:temp_id,winner_name:[data[i]["party2000"] + "2000",data[i]["party2004"] + "2004" + data[i]["Switch_2000_2004"],data[i]["party2008"] + "2008" + data[i]["Switch_2004_2008"],data[i]["party2012"] + "2012" + data[i]["Switch_2008_2012"],data[i]["party2016"] + "2016" + data[i]["Switch_2012_2016"]]});  
        }
        drawScreen(winner);         
    });}
